...
public class Account implements Serializable {
	...
	public ImageIcon getAvatar() {
		if(avatarString!=null) return ImageEncode64.decoder(this.avatarString);
		if(avatar==null&&avatarString==null) return new ImageIcon(Account.class.getResource("/img/wolfuser.png"));
		return avatar;
	}
	public Account() {
		this.email=null;
