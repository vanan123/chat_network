...
public class RegisterFrame extends JFrame {
	...
	public RegisterFrame() {
		...
		backToLogin.setBounds(390, 554, 191, 39);
	...
	private Account getAccountRegister() {
		try {
			...
			if(result==1) {
				...
				JOptionPane.showMessageDialog(login, "SUCCESSFULL!");
			} else {
